      ...
      <div className="container-fluid content_parent_panel">
          <div className="col-12 w-100 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
            <div className="container">
              <div className="container-fluid content_panel overflow-auto mt-3">
              {
                (() => {
                  let container = [];
                      ...
                      <>
                        <div className="details">
                          ...
                          <div className="summary overflow-auto">
                            ...
                            <div className="card card-body m-1 overflow-auto text_content" dangerouslySetInnerHTML = {{__html:val.text_content}} />
                          </div>
                        </div>
                      </>
                    )
